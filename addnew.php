  ...
  <div>
    ...
    <div class="item">
      <ul class="nostyle zero">
        ...
        <a href="inventeries.php"><li><i class="fa fa-circle-o fa-fw"></i> Inventories</li></a>
       <a href="addnew.php"><li style="color: white"><i class="fa fa-circle-o fa-fw"></i> Add New Product</li></a>
        <a href="reports.php"><li><i class="fa fa-circle-o fa-fw"></i> Report</li></a>
        <a href="chart.php"><li><i class="fa fa-circle-o fa-fw"></i> Chart</li></a>
      </ul><
    </div>
  </div>
      ...
      <form method="POST">
         <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="text" name="unit" placeholder="( ml, mg, ply, pc, tablet )" class="form-control" id="some" required>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <label for="some" class="col-form-label">Information</label>
            <input type="text" name="supplier"  class="form-control" id="some" required>
          </div>
          <div class="form-group">
            <label for="some" class="col-form-label">Distributor</label>
            <input type="text" name="company"  class="form-control" id="some" required>
          </div>
          <div class="form-group">
            <label for="some" class="col-form-label">Please Select </label>
